...
function Home() {
  ...
  <div className="relative w-full min-h-screen ">
      ...
      <div className=' w-full h-full absolute top-0 left-0 flex flex-col justify-center  md:text-6xl lg:text-6xl text-4xl font-semibold font-body text-black p-9 mx-5 mt-[160px]  '>
